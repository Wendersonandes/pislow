    ...
    $(document).scroll(function() {
         if($(this).scrollTop()>10) {
                $("#order_details_checkout").css("margin-bottom",$(this).scrollTop()-10) ;
            }   
         else {
                $("#order_details_checkout").css("margin-bottom",$(this).scrollTop()-0) ;
              }
...
$(document).ready(function () {
    ...
    /*==============================================================*/ 
    var $cart_trigger2 = $('#link-to-cart2'),
    ...
    $('#accept_terms_and_conditions').click(function () {
        ...
        if ($(this).is(':checked')) {
            ...
            $('#button_pay').removeAttr('disabled'); //enable input
    ...
    $('#cleaning_service').on('click',function() 
        {
            if ($('#cleaning_service').is(':checked')) {
                $(".cleaning_on").show();
                $(".cleaning_off").hide();
            } else {
                $(".cleaning_on").hide();
    ...
    $('#assegurance_service').on('click',function() 
        {
            if ($('#assegurance_service').is(':checked')) {
                $(".assegurance_on").show();
                $(".assegurance_off").hide();
            } else {
                $(".assegurance_on").hide();
                $(".assegurance_off").show();
            } 
        });

    /* ===================================
    My clothes: Show radiobuttons
    ====================================== */

     $("[id*='myclothes_continue']").on('click',function() 
      
        {  var target = $(this).attr('name');
           var button = document.getElementById(target);        
           $(button).html('Continuar con la prenda');

           $("#myclothes_continue_text").show();
           $("#myclothes_buy_text").hide();
           $("#myclothes_return_rent_text").hide();


        });
     $("[id*='myclothes_buy']").on('click',function() 
        {  var target = $(this).attr('name');
           var button = document.getElementById(target);        
           $(button).html('Comprar');

           $("#myclothes_buy_text").show();
           $("#myclothes_continue_text").hide();
           $("#myclothes_return_rent_text").hide();


        });
     $("[id*='myclothes_return_rent']").on('click',function() 
        {  var target = $(this).attr('name');
           var button = document.getElementById(target);        
           $(button).html('Devolver');

           $("#myclothes_return_rent_text").show();
           $("#myclothes_buy_text").hide();
           $("#myclothes_continue_text").hide();
    ...
    if (!isMobile) {
        ...
        if (!isMobile) {
        jQuery(".top-cart a.wishlist, .wishlist-content").hover(function () {
            jQuery(".wishlist-content").css('opacity', '1');
            jQuery(".wishlist-content").css('visibility', 'visible');
        }, function () {
            jQuery(".wishlist-content").css('opacity', '0');
            jQuery(".wishlist-content").css('visibility', 'hidden');
        });
    }
        if (!isMobile) {
        jQuery(".top-cart a.usersettings, .usersettings-content").hover(function () {
            jQuery(".usersettings-content").css('opacity', '1');
            jQuery(".usersettings-content").css('visibility', 'visible');
        }, function () {
            jQuery(".usersettings-content").css('opacity', '0');
            jQuery(".usersettings-content").css('visibility', 'hidden');
        });
    }
        if (!isMobile) {
        jQuery("a.myclothes, .myclothes-content").hover(function () {
            jQuery(".myclothes-content").css('opacity', '1');
            jQuery(".myclothes-content").css('visibility', 'visible');
        }, function () {
            jQuery(".myclothes-content").css('opacity', '0');
            jQuery(".myclothes-content").css('visibility', 'hidden');
        });
    }
    if (isiPhoneiPad) {
    ...
    jQuery(".top-cart a.shopping-cart").click(function () {
        ...
        jQuery(".top-cart a.wishlist").click(function () {
        //$('.navbar-collapse').collapse('hide');

        if ($('.wishlist-content').css('visibility') == 'visible') {
            jQuery(".wishlist-content").css('opacity', '0');
            jQuery(".wishlist-content").css('visibility', 'hidden');
        }
        else {
        ...
        jQuery(".top-cart a.usersettings").click(function () {
        //$('.navbar-collapse').collapse('hide');

        if ($('.usersettings-content').css('visibility') == 'visible') {
            jQuery(".usersettings-content").css('opacity', '0');
            jQuery(".usersettings-content").css('visibility', 'hidden');
        }
        else {
        ...
        jQuery("a.myclothes").click(function () {
        //$('.navbar-collapse').collapse('hide');

        if ($('.myclothes-content').css('visibility') == 'visible') {
            jQuery(".myclothes-content").css('opacity', '0');
            jQuery(".myclothes-content").css('visibility', 'hidden');
        }
        else {
...
/*==============================================================*/
// Filter products mobile hide in icon filter
/*==============================================================*/
...
$(document).ready(function() {
  ...
  $('.js-dropp-action').click(function(e) {
    ...
    var value = $("input[name='variant_id']:checked").closest('label').text();
    $('.js-value').text(value);
    if (value.indexOf("hand") >= 0) {
        $('#period_buy').parent().css('border', '2px solid #000');
        $('#period_month').parent().css('display', 'none');
        $('#period_week').parent().css('display', 'none');
        $('#period_month').parent().css('border', '1px solid #dcdcdc');
        $('#period_week').parent().css('border', '1px solid #dcdcdc');
        $('#period_buy').prop("checked", true);

     }
    else{
        $('#period_month').parent().css('display', 'initial');
        $('#period_week').parent().css('display', 'initial');
