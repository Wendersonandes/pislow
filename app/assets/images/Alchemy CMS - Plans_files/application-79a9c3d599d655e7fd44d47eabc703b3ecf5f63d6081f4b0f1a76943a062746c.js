...
(function() {
  Spree.ready(function($) {
    var selectedoption, selectoptions;
    ...
    selectoptions = $('#product-variants select');
    if (selectoptions.length > 0) {
      selectedoption = $('#product-variants option:selected');
      Spree.showVariantImages(selectedoption.attr('value'));
      Spree.updateVariantPrice(selectedoption);
    }
    Spree.addImageHandlers();
    return selectoptions.change(function(event) {
      selectedoption = $('#product-variants option:selected');
      Spree.showVariantImages(this.value);
      return Spree.updateVariantPrice(selectedoption);
    });
  });
...
disable_steps = function(all) {
  ...
  elements.find("submit").attr("disabled", "disabled");
